...
class Media extends \Shopware\Models\Media\Media implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'attribute', 'articles', 'blogMedia', 'properties', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'defaultThumbnails', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'id', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'albumId', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'name', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'description', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'path', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'type', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'extension', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'userId', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'created', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'file', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'fileSize', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'width', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'height', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'album', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'thumbnails', '' . "\0" . 'Shopware\\Models\\Media\\Media' . "\0" . 'highDpiThumbnails'];
        }
    ...
    public function removeThumbnails()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeThumbnails', []);

        return parent::removeThumbnails();
    }
