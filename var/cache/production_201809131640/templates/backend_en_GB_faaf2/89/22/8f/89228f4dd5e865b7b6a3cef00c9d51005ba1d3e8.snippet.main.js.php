<?php /* Smarty version Smarty-3.1.12, created on 2018-10-09 13:55:15
         compiled from "C:\XAMPP\xampp\htdocs\shopware\themes\Backend\ExtJs\backend\product_stream\controller\main.js" */ ?>
<?php /*%%SmartyHeaderCode:3026565415bbc9723cebe79-63301008%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89228f4dd5e865b7b6a3cef00c9d51005ba1d3e8' => 
    array (
      0 => 'C:\\XAMPP\\xampp\\htdocs\\shopware\\themes\\Backend\\ExtJs\\backend\\product_stream\\controller\\main.js',
      1 => 1537260006,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3026565415bbc9723cebe79-63301008',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5bbc9723d12284_51982106',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbc9723d12284_51982106')) {function content_5bbc9723d12284_51982106($_smarty_tpl) {?>/**
 * Shopware 5
                ...
                duplicatedRecord.save({
                    success: function (newRecord) {
                        if (newRecord.get('type') == 2) {
                            Ext.Ajax.request({
                                url: '<?php echo '/shopware/backend/ProductStream/copySelectedProducts';?>',
                                params: {
                        ...
                        Ext.Ajax.request({
                            url: '<?php echo '/shopware/backend/ProductStream/copyStreamAttributes';?>',
                            params: {
                                sourceStreamId: record.get('id'),
                                targetStreamId: newRecord.get('id')
                            }
