<?php /* Smarty version Smarty-3.1.12, created on 2018-10-09 13:55:09
         compiled from "C:\XAMPP\xampp\htdocs\shopware\themes\Backend\ExtJs\backend\base\store\product_box_layout.js" */ ?>
<?php /*%%SmartyHeaderCode:20515022735bbc971ddfb546-94227401%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a26fc69c57ad0d527cb19d6d6523c33ab5209671' => 
    array (
      0 => 'C:\\XAMPP\\xampp\\htdocs\\shopware\\themes\\Backend\\ExtJs\\backend\\base\\store\\product_box_layout.js',
      1 => 1537259997,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20515022735bbc971ddfb546-94227401',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5bbc971de1ed18_01742958',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbc971de1ed18_01742958')) {function content_5bbc971de1ed18_01742958($_smarty_tpl) {?>/**
 * Shopware 5
    ...
    constructor: function(config) {
        ...
        if (this.getConfigValue(config, 'displayExtendLayout')) {
            data.push({
                ...
                image: '/shopware/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_parent.png'
            });
        }
        if (this.getConfigValue(config, 'displayBasicLayout')) {
            data.push({
                ...
                image: '/shopware/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_basic.png'
            });
        }
        if (this.getConfigValue(config, 'displayMinimalLayout')) {
            data.push({
                ...
                image: '/shopware/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_minimal.png'
            });
        }
        if (this.getConfigValue(config, 'displayImageLayout')) {
            data.push({
                ...
                image: '/shopware/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_image.png'
            });
        }
        if (this.getConfigValue(config, 'displayListLayout')) {
            data.push({
                ...
                image: '/shopware/themes/Backend/ExtJs/backend/_resources/images/category/layout_box_list.png'
            });
        }
