<?php /* Smarty version Smarty-3.1.12, created on 2018-10-09 13:55:16
         compiled from "C:\XAMPP\xampp\htdocs\shopware\themes\Backend\ExtJs\backend\article\controller\esd.js" */ ?>
<?php /*%%SmartyHeaderCode:12852025805bbc9724b21948-30639535%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c6b6125750e7ebb290998f82a9c8e4a77b38aa10' => 
    array (
      0 => 'C:\\XAMPP\\xampp\\htdocs\\shopware\\themes\\Backend\\ExtJs\\backend\\article\\controller\\esd.js',
      1 => 1537259994,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12852025805bbc9724b21948-30639535',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5bbc9724b566f5_31301169',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbc9724b566f5_31301169')) {function content_5bbc9724b566f5_31301169($_smarty_tpl) {?>/**
 * Shopware 5
...
'
    ...
    onAddEsd: function(articleDetailId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware/backend/Article/createEsd';?>',
            method: 'POST',
            params: {
    ...
    saveNewSerials: function(serials) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware/backend/Article/saveSerials';?>',
            method: 'POST',
            params: {
    ...
    onDeleteUnusedSerials: function() {
        ...
        Ext.MessageBox.confirm(me.snippets.growlMessage, me.snippets.messages.serialsRemoveUnused , function (response) {
            ...
            Ext.Ajax.request({
                url: '<?php echo '/shopware/backend/Article/deleteUnusedSerials';?>',
                method: 'POST',
                params: {
                    esdId: me.detailWindow.esdRecord.get('id')
                },
    ...
    onDownloadFile: function() {
        ...
        var url = '<?php echo '/shopware/backend/Article/getEsdDownload';?>' + '/filename/' + record.get('file');
