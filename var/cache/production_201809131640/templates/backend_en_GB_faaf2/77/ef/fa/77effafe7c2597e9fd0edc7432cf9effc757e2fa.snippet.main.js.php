<?php /* Smarty version Smarty-3.1.12, created on 2018-10-09 13:55:15
         compiled from "C:\XAMPP\xampp\htdocs\shopware\themes\Backend\ExtJs\backend\article_list\controller\main.js" */ ?>
<?php /*%%SmartyHeaderCode:14870234885bbc972373b6f8-23619966%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '77effafe7c2597e9fd0edc7432cf9effc757e2fa' => 
    array (
      0 => 'C:\\XAMPP\\xampp\\htdocs\\shopware\\themes\\Backend\\ExtJs\\backend\\article_list\\controller\\main.js',
      1 => 1537259995,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14870234885bbc972373b6f8-23619966',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5bbc9723751b04_58594606',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbc9723751b04_58594606')) {function content_5bbc9723751b04_58594606($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.apps.ArticleList.controller.Main', {
    ...
    loadDetailModelFields: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware/backend/ArticleList/columnConfig';?>',
            params: {
                resource: 'product'
            },
            method: 'GET',
    ...
    createDetailModel: function (data) {
        ...
        Ext.define('Shopware.apps.ArticleList.model.Detail', {
            ...
            proxy: {
                 ...
                 */
                api: {
                    create: '<?php echo '/shopware/backend/ArticleList/saveSingleEntity';?>',
                    update: '<?php echo '/shopware/backend/ArticleList/saveSingleEntity';?>',
                    destroy: '<?php echo '/shopware/backend/ArticleList/deleteProduct';?>'
                },
