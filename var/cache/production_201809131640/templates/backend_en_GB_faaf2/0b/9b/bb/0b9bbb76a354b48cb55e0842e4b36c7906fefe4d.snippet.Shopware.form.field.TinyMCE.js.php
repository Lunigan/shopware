<?php /* Smarty version Smarty-3.1.12, created on 2018-10-09 13:55:10
         compiled from "C:\XAMPP\xampp\htdocs\shopware\themes\Backend\ExtJs\backend\base\component\Shopware.form.field.TinyMCE.js" */ ?>
<?php /*%%SmartyHeaderCode:14923876855bbc971e03e1f4-87553146%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0b9bbb76a354b48cb55e0842e4b36c7906fefe4d' => 
    array (
      0 => 'C:\\XAMPP\\xampp\\htdocs\\shopware\\themes\\Backend\\ExtJs\\backend\\base\\component\\Shopware.form.field.TinyMCE.js',
      1 => 1537259997,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14923876855bbc971e03e1f4-87553146',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbc971e05fad4_77135797',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbc971e05fad4_77135797')) {function content_5bbc971e05fad4_77135797($_smarty_tpl) {?>/**
 * Shopware 5
...
",
            ...
            document_base_url: '<?php ob_start();?><?php echo 'http://localhost/shopware/backend';?><?php $_tmp1=ob_get_clean();?><?php echo $_tmp1;?>
/'.replace('/backend', ''),
            
            // Content CSS - Styles the tiny mce editor. Please note the append timestamp. It's used to prevent caching the stylesheet
            contentCSS: 'http://localhost/shopware/themes/Backend/ExtJs/backend/_resources/styles/tiny_mce.css?_dc=' + new Date().getTime(),
     ...
     */
    preloadImageUrl: '<?php echo '/shopware/backend/MediaManager/getMediaUrls';?>',
    ...
    replaceSmartyPluginWithImagePaths: function(rawContent) {
        ...
        Ext.each(images, function(img) {
            ...
            element.setAttribute('src', '/shopware/engine/Library/TinyMce/plugins/media_selection/assets/placeholder-image.png');
        });
